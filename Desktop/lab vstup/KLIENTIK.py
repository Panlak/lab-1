...
top = tkinter.Tk()
top.title("НЕМА ФАНТАЗІЇ НЕМАЄ В ТІЙ ЖІЗНІ")
messages_frame = tkinter.Frame(top)

my_msg = tkinter.StringVar()  #ДЛЯ ОТПРАВКЫ
my_msg.set("")
scrollbar = tkinter.Scrollbar(messages_frame)  #ЯНДЕКС НАВИГАТОР
msg_list = tkinter.Listbox(messages_frame, height=12, width=65, yscrollcommand=scrollbar.set)
...
button_label = tkinter.Label(top, text="Напиши шось блін:")
button_label.pack()
